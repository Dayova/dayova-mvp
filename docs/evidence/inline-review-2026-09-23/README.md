...
| --- | --- |
| <img src="../user-image-archive-2026-09-23/historical-annotated/IMG_1439.png" width="180" alt="Historisch, iPad" /> | <img src="../jakob-qa-2026-09-22/dayova-qa-times-add.png" width="180" alt="Gemeinsamer QA-Stand, iPad" /> |

### iPhone: gespeicherte Lernzeit

<img src="../user-screenshots-2026-09-23/iphone-15.59.04.png" width="180" alt="iPhone: gespeicherte Lernzeit" />

### iPhone: bearbeiten

<img src="../user-screenshots-2026-09-23/iphone-15.59.12.png" width="180" alt="iPhone: bearbeiten" />

### iPhone: Swipe-Aktion

<img src="../user-screenshots-2026-09-23/iphone-15.59.06.png" width="180" alt="iPhone: Swipe-Aktion" />

### Android: gespeichert

<img src="../user-image-archive-2026-09-23/additional-qa/android-time-saved.png" width="180" alt="Android: gespeichert" />

### Android: bearbeiten

<img src="../user-image-archive-2026-09-23/additional-qa/android-time-edit.png" width="180" alt="Android: bearbeiten" />

### Android: Swipe-Aktion

<img src="../user-image-archive-2026-09-23/additional-qa/android-time-swipe.png" width="180" alt="Android: Swipe-Aktion" />
...
| --- | --- |
| <img src="../user-image-archive-2026-09-23/historical-original/IMG_1675.png" width="180" alt="Historisch, iPhone" /> | <img src="../user-image-archive-2026-09-23/additional-qa/ipad-material-picker.png" width="180" alt="Nutzeraufnahme 22.09., iPad" /> |
...
| --- | --- |
| <img src="../day-402-iphone-comparison/before.png" width="180" alt="iphone — PR-Base" /> | <img src="../day-402-iphone-comparison/after.png" width="180" alt="iphone — PR-Head" /> |

| ipad — PR-Base | ipad — PR-Head |
| --- | --- |
| <img src="../day-402-ipad-comparison/before.png" width="180" alt="ipad — PR-Base" /> | <img src="../day-402-ipad-comparison/after.png" width="180" alt="ipad — PR-Head" /> |

| android — PR-Base | android — PR-Head |
| --- | --- |
| <img src="../day-402-android-comparison/before.png" width="180" alt="android — PR-Base" /> | <img src="../day-402-android-comparison/after.png" width="180" alt="android — PR-Head" /> |
...
| --- | --- |
| <img src="../user-image-archive-2026-09-23/historical-original/IMG_1670.png" width="180" alt="Historisch: kein Hinzufügen-Eintrag" /> | <img src="../user-screenshots-2026-09-23/ipad-16.00.05.png" width="180" alt="iPad: Fach hinzufügen sichtbar" /> |

### iPad: Eingabedialog

<img src="../user-screenshots-2026-09-23/ipad-16.00.26.png" width="180" alt="iPad: Eingabedialog" />

### Android: Fach umbenennen

<img src="../user-image-archive-2026-09-23/additional-qa/android-subject-rename.png" width="180" alt="Android: Fach umbenennen" />

### Android: Swipe-Aktion

<img src="../user-image-archive-2026-09-23/additional-qa/android-subject-swipe.png" width="180" alt="Android: Swipe-Aktion" />

### Android: Auswahl

<img src="../user-screenshots-2026-09-23/android-subjects.png" width="180" alt="Android: Auswahl" />
...
| --- | --- |
| <img src="../user-image-archive-2026-09-23/historical-original/IMG_1676.png" width="180" alt="Historisch: 7-MiB-Grenze" /> | <img src="../user-image-archive-2026-09-23/additional-qa/ipad-material-page.png" width="180" alt="Neuere Anzeige, iPad" /> |

### QA: nur 804 Byte als hochgeladen angezeigt

<img src="../jakob-qa-2026-09-23/ipad-material-upload-success.png" width="180" alt="QA: nur 804 Byte als hochgeladen angezeigt" />
...
| --- | --- |
| <img src="../user-image-archive-2026-09-23/historical-original/IMG_1680.png" width="180" alt="Historischer Fehler" /> | <img src="../jakob-qa-2026-09-23/ipad-generation-config-error.png" width="180" alt="QA-Fehler 23.09." /> |
...
<img src="../user-image-archive-2026-09-23/additional-qa/ipad-account-delete-failed.png" width="180" alt="Kontolöschung fehlgeschlagen" />
...
| iPhone — PR-Base | iPhone — PR-Head |
| --- | --- |
| <img src="../open-pr-audit-2026-09-22/shared-parent-00c5b19/before.png" width="180" alt="iPhone — PR-Base" /> | <img src="../open-pr-audit-2026-09-22/pr-693/after.png" width="180" alt="iPhone — PR-Head" /> |

| Android — PR-Base | Android — PR-Head |
| --- | --- |
| <img src="../day-693-android/before-plans.png" width="180" alt="Android — PR-Base" /> | <img src="../day-693-android/after-plans.png" width="180" alt="Android — PR-Head" /> |
...
<img src="../combined-native-retest-2026-09-23/ipad-back-subject.png" width="180" alt="ipad: Fach nach Zurück" />

### iphone: Fach nach Zurück

<img src="../combined-native-retest-2026-09-23/iphone-back-subject.png" width="180" alt="iphone: Fach nach Zurück" />

### android: Fach nach Zurück

<img src="../combined-native-retest-2026-09-23/android-back-subject.png" width="180" alt="android: Fach nach Zurück" />

### ipad: Hausaufgabe nach Zurück

<img src="../homework-and-plan-dialog-2026-09-23/ipad/homework-retained.png" width="180" alt="ipad: Hausaufgabe nach Zurück" />

### iphone: Hausaufgabe nach Zurück

<img src="../homework-and-plan-dialog-2026-09-23/iphone/homework-retained.png" width="180" alt="iphone: Hausaufgabe nach Zurück" />

### android: Hausaufgabe nach Zurück

<img src="../homework-and-plan-dialog-2026-09-23/android/homework-retained.png" width="180" alt="android: Hausaufgabe nach Zurück" />
...
<img src="../jakob-qa-2026-09-23/ipad-generation-config-error.png" width="180" alt="Vorgelagerte QA-Erstellung fehlgeschlagen" />
...
| --- | --- |
| <img src="../homework-and-plan-dialog-2026-09-23/ipad/plan-delete-light.png" width="180" alt="Light Mode" /> | <img src="../homework-and-plan-dialog-2026-09-23/ipad/plan-delete-dark.png" width="180" alt="Dark Mode" /> |
