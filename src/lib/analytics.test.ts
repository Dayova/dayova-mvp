	...
	it("before_send sanitizes nested person updates on PostHog system events", () => {
		const guarded = validationAnalyticsBeforeSend({
			...
			properties: {
				...
				answerTranscript: "private typed answer",
				transcript: "private spoken answer",
				diagnostic_error_detail: "private provider response",
				learner_answer: "private learner answer",
				uploaded_file_contents: "private document contents",
				diagnostic_response_body: "private provider response body",
				$set: {
					convex_user_id: "convex_user_456",
					email: "private@example.com",
					$email: "private@example.com",
