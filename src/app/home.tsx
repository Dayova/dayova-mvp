...
export default function HomeScreen() {
	...
	return (
		<View className="flex-1 pt-16" style={{ backgroundColor: "#F5F3F6" }}>
			...
			<View className="px-8">
				<View className="mt-[65px] mb-1 ml-9 flex-row items-center justify-between">
					<View>
						<Text className="font-medium font-poppins text-20 text-text">
							Hi, {firstName} 👋
						</Text>
						<Text className="mt-1 font-bold font-poppins text-16 text-text">
							{taskSummary}
						</Text>
					</View>
					<TouchableOpacity
					...
					>
						<View
							className="mr-20 h-[55px] w-[55px] items-center justify-center rounded-full pl-0.5"
							style={{
					...
					{!isSelectedToday && !isReturningToToday ? (
						<View className="mt-1 items-center">
							...
							>
								...
								<Text className="font-bold font-poppins text-13 text-[#2F68E8]">
									Zurück zu heute
								</Text>
							</TouchableOpacity>
						</View>
						...
						return (
							...
							>
								<View className="w-20 pt-1.5 pr-2">
									<Text
										className="font-medium font-poppins text-14 text-text/78"
										style={{ marginLeft: 10 }}
									>
								...
								<View className="flex-1 pb-3">
									<View
										className="mt-2 mb-2 h-[2px] w-full rounded-full"
										style={{
											backgroundColor:
													...
													>
														<View className="flex-row items-center justify-between">
															<View className="flex-1 pr-3">
																<Text
																	className="font-poppins font-semibold text-14 text-[#1A1A1A]"
																	style={{ marginLeft: 24 }}
																>
																	{getEntryLabel(entry)}
																</Text>
			...
			<View
				className="absolute right-0 bottom-6 left-0 flex-row items-center justify-center"
				style={{
					shadowColor: "#6D6D6D",
					shadowOpacity: 0.23,
					shadowRadius: 9,
			...
			>
				<View
					className="h-20 w-3/5 flex-row items-center justify-evenly overflow-hidden rounded-full"
				...
				>
					...
					<TouchableOpacity
						...
						className="h-[68px] w-20 items-center justify-center rounded-full pt-1"
					>
						<CalendarDays
							size={22}
							color="#1A1A1A"
				...
				<TouchableOpacity
					...
					className="ml-3 items-center justify-center overflow-hidden rounded-full"
					style={{
						width: 65,
						height: 65,
					...
					>
						<View className="mb-4 flex-row items-start justify-between">
							<View className="flex-1 pr-4">
								<UiText className="font-bold font-poppins text-24 text-text">
						...
						>
							...
							<View className="ml-3 flex-1">
								<UiText className="font-bold font-poppins text-16 text-white">
									Neue Hausaufgabe
								</UiText>
						...
						>
							...
							<View className="ml-3 flex-1">
								<UiText className="font-bold font-poppins text-16 text-text">
