  ...
  return (
    ...
    >
      <View className="mb-2 flex-row items-center">
        {icon}
        <Text className="ml-2 font-poppins text-12 font-bold uppercase text-text/56">
          {label}
        </Text>
      </View>
      <Text className="font-poppins text-16 font-bold text-text">{value}</Text>
    </View>
  );
}
    ...
    <View className="flex-1 bg-background">
      ...
      >
        ...
        <View className="mb-8">
          ...
          {kind ? (
            <Text className="mt-3 font-poppins text-14 font-bold uppercase text-primary">
              {kind}
            </Text>
          ) : null}
        </View>
