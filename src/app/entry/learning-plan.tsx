...
function Header({
  ...
  return (
    <View className="mb-8 flex-row items-center justify-between">
      ...
      <Text className="font-poppins text-16 font-bold text-text">{title}</Text>
...
function SectionTitle({
  ...
  return (
    <View className="mb-7">
      <Text className="font-poppins text-18 font-bold text-text">{title}</Text>
  ...
  return (
    ...
    >
      ...
      <View className="ml-3 flex-1">
        <Text
          numberOfLines={1}
          className="font-poppins text-14 font-bold text-text"
        >
          {name}
        </Text>
...
function UploadAction({
  ...
  return (
    ...
    >
      ...
      <Text className="mt-3 text-center font-poppins text-12 font-semibold text-text/62">
        {label}
      </Text>
    </TouchableOpacity>
  );
  ...
  return (
    ...
    >
      <View className="h-14 w-14 items-center justify-center rounded-full bg-[#1A1A1A]">
        <Text className="font-poppins text-14 font-bold text-white">
          {session.dateLabel.split(" ")[0]}
        </Text>
      </View>
      <View className="ml-4 flex-1">
        <View className="flex-row items-center">
          <Text className="font-poppins text-16 font-bold text-text">
            {session.title}
          </Text>
          <Icon
            size={18}
      ...
      >
        ...
        {step === "topic" ? (
          <>
            ...
            />
            <Text className="mb-3 font-poppins text-12 font-bold text-text">
              Thema beschreiben
            </Text>
            <View
        ...
        {step === "analysisIntro" ? (
          <View className="flex-1 items-center pt-8">
            ...
            <Text className="self-start font-poppins text-18 font-bold text-text">
          ...
          <>
            <View className="mb-7 items-center">
              <View className="h-16 w-16 items-center justify-center rounded-full bg-primary/55">
                <Text className="font-poppins text-20 font-bold text-white">
                  {questionIndex + 1}
                </Text>
              </View>
            </View>
            ...
            <Text className="mt-2 font-poppins text-18 font-bold text-text">
              {currentQuestion.prompt}
            </Text>
            <Text className="mt-7 mb-3 font-poppins text-12 font-bold text-text">
              Antwort
            </Text>
      ...
      <Modal visible={Boolean(deleteSession)} transparent animationType="fade">
        <View className="flex-1 justify-end">
          ...
          <View className="mx-8 mb-9 items-center rounded-[30px] bg-white px-5 pt-7 pb-5">
            ...
            <Text className="font-poppins text-18 font-bold text-text">
              Bist du dir sicher?
            </Text>
